...
TEST_CASE("Cercle", "[Cercle]")
{
	...
	Cercle c1;
	Cercle c2(Point(10, 20), COULEURS::ROUGE, 1);

	REQUIRE(c1.toString() == "CERCLE 0 0 0 0");
	REQUIRE(c2.toString() == "CERCLE 10 20 0 0");

	c2.setRayon(45);
	REQUIRE(c2.getRayon() == 45);
	REQUIRE(c2.toString() == "CERCLE 10 20 45 45");
	REQUIRE(c2.getLargeur() == 45);
	REQUIRE(c2.getHauteur() == 45);
...
TEST_CASE("Groupe", "[Groupe]")
{
	...
	REQUIRE(g.toString() == "GROUPE 0 0 0 0\nCERCLE 0 0 0 0\nRECTANGLE 0 0 0 0\n");
